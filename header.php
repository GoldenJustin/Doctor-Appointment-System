        ...
        <div class="row">
            <div class="col-lg-3 col-xs-4 col-sm-12 logo-col">
                <div class="logo animated fadeInLeft">
                    <h1><a   style="padding:15px;background-color:#a01f62;color:white; font-family: Georgia Header;border-radius:50px 0px 50px 0px" href="index.php">HealthConnect</a></h1>
                </div>
            </div>
            ...
            <div class="modal-content login-modal">
				...
				<div class="col-lg-6">
					<div class="bac-right-login">
						<h4>I'm new in HealthConnect</h4>
						<h5>Sign up for a account to book an appointment right now!</h5>
						<a href = "presignup.php">I'm new in HealthConnect</a>
					</div>
				</div>
			</div>
		</div>
