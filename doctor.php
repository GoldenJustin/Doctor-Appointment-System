	...
	<div class="row">
						...
						<div class="col-lg-6">
							...
							<div class="form-group">
								...
								<select class="form-control" class="selectmedtype" id="exampleSelect1" name="fees"  onchange="changemedtype(this);" >
													...
													<option value="Tshs. 5000">Tshs. 5000</option>
													<option value="Tshs. 10000">Tshs. 10000</option>
													<option value="Tshs. 15000">Tshs. 15000</option>
													<option value="Tshs. 20000">Tshs. 20000</option>
								</select>
								</div>
							<div class="form-group">
							...
							<option value="Mbezi">Mbezi</option>
								<option value="Bamaga">Bamaga</option>
									<option value="Masaki">Masaki</option>
											...
											<option value="Muhimbili">Muhimbili</option>
													<option value="Masassi">Masassi</option>
												<option value="Ruvu">Ruvu</option>
													<option value="Kibaha">Kibaha</option>
														<option value="Mnazi Mmoja">Mnazi Mmoja</option>
																<option value="Makumbusho">Makumbusho</option>
																<option value="Manzese">Manzese</option>
																<option value="Ubungo">Ubungo</option>
								</select>
							</div>
		...
		<div class="col-lg-5">
			<div class="bac-right-login-2">
				<h3>You’ll love being on HealthConnect</h3>
				<ul>
					<li>Access HealthConnect network of  patients.</li>
					<li>Let patients schedule appointments with you instantly, 24-7, from HealthConnect and from your practice website.</li>
				</ul>
			</div>
		</div>
	</div>
